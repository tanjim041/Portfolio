...
const ProjectCard = memo(function ProjectCard({ project, index = 0 }) {
  ...
  return (
    <motion.div
      className="bg-card border border-border rounded-2xl overflow-hidden flex flex-col group hover:-translate-y-2 hover:border-accent-primary/50 transition-all duration-300"
      ...
      <div className="p-6 flex-1 flex flex-col">
        ...
        <div className="flex items-center gap-4 mt-auto pt-4 border-t border-border/50">
          <a
            ...
            className="flex flex-1 items-center justify-center gap-2 py-2 px-4 bg-secondary hover:bg-white hover:text-black rounded-lg text-sm font-medium transition-colors"
